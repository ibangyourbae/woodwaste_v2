                                    ...
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-body">
                                            <form action="/admin/wooddata/{{ $wooddata->id }}/update" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    @csrf
                                                    <div class="mb-3">
                                                        <label for="jumlah" class="form-label">Jumlah {{ $wooddata->title }} (Kg)</label>
                                                        <input type="text" class="form-control @error('jumlah') is-invalid @enderror" id="jumlah" jumlah="jumlah" value="{{ old('jumlah',$wooddata->jumlah) }}">
                                                        @error('jumlah')
