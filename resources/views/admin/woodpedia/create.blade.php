                            ...
                            <div class="col-xl-12 col-lg-7">
                                    ...
                                    <div class="card shadow mb-4">
                                        <div class="card-header py-3">
                                            <h6 class="m-0 font-weight-bold text-primary">Input Woodpedia</h6>
                                        </div>
                                        <div class="card-body">
                                            <form action="{{ route('woodpedia.store') }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="image" class="form-label">Gambar Woodpedia</label>
