    ...
    <div class="container layer3">
        <div class="row mt-5">
            <div class="card  card1">
                <h1 class="card-title mt-5">Mulai jual beli sekarang!</h1>
                <h2 class="subtitle"> Kontribusi dalam pengolahan limbah industri kayu sekarang</h2>
                <div class="card-body mt-5">
                    <a href="/register"><button type="button" class="btn card-btn">Daftar</button></a>
                    <a href="/login"><button type="button" class="btn card-btn">Masuk</button></a>
                </div>
            </div>
        </div>
